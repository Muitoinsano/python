...
# Importa a classe que foi criada
from http_metrics.InstrumentedRequest import InstrumentedRequest

app = FastAPI()
LOG_CODE = "SERVICE_WHO"
instrumented_request = InstrumentedRequest(LOG_CODE)
...
async def test_post(request: Request, id_cards: str = None):
    ...
    try:
        if request.method == 'POST':
            ...
            response = instrumented_request.request(
                {
                    "method": "POST",
